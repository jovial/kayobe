...
class BaremetalComputeUpdateDeploymentImage(KayobeAnsibleMixin, VaultMixin, Command):
    ...
    def get_parser(self, prog_name):
        ...
        group.add_argument("--baremetal-compute-limit",
                           help="Limit the upgrade to the hosts specified in this limit")
        return parser

    def take_action(self, parsed_args):
        self.app.LOG.debug("Upgrading the ironic nodes to use the latest  deployment images")
        ...
        if parsed_args.baremetal_compute_limit:
            extra_vars["ipa_images_compute_node_limit"] = parsed_args.baremetal_compute_limit
        self.run_kayobe_playbooks(parsed_args, playbooks,
                                  extra_vars=extra_vars)
