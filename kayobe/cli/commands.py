...
class BaremetalComputeSerialConsoleEnable(KayobeAnsibleMixin, VaultMixin, Command):
...
class BaremetalComputeSerialConsoleDisable(KayobeAnsibleMixin, VaultMixin, Command):
